...
from routes import health, pdf, video, stream_chat, axa_hr, finance_report_gen
...
app.include_router(axa_hr.router, prefix='/api', dependencies=[Depends(validateToken)], tags=["AxaHrChat"])
